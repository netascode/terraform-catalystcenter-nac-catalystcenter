...
resource "catalystcenter_authentication_policy_server" "ise" {
  ...
  role                      = "primary"
  shared_secret_wo          = sensitive(try(local.catalyst_center.system_settings.authentication_and_policy_servers.ise.shared_secret, local.defaults.catalyst_center.system_settings.authentication_and_policy_servers.ise.shared_secret, null))
  ...
  cisco_ise_dtos = [
    {
      ...
      password_wo         = sensitive(try(local.catalyst_center.system_settings.authentication_and_policy_servers.ise.password, local.defaults.catalyst_center.system_settings.authentication_and_policy_servers.ise.password, null))
...
resource "catalystcenter_authentication_policy_server" "aaa" {
  ...
  role                      = "primary"
  shared_secret_wo          = sensitive(try(each.value.shared_secret, local.defaults.catalyst_center.system_settings.authentication_and_policy_servers.aaa.shared_secret, null))
  ...
  encryption_key_wo         = sensitive(can(each.value.protocols.radius.enable_key_wrap) ? try(each.value.protocols.radius.enable_key_wrap.encryption_key, local.defaults.catalyst_center.system_settings.authentication_and_policy_servers.aaa.protocols.radius.enable_key_wrap.encryption_key, null) : null)
  encryption_key_wo_version = try(each.value.protocols.radius.enable_key_wrap.encryption_key_version, local.defaults.catalyst_center.system_settings.authentication_and_policy_servers.aaa.protocols.radius.enable_key_wrap.encryption_key_version, 1)
  message_key_wo            = sensitive(can(each.value.protocols.radius.enable_key_wrap) ? try(each.value.protocols.radius.enable_key_wrap.message_key, local.defaults.catalyst_center.system_settings.authentication_and_policy_servers.aaa.protocols.radius.enable_key_wrap.message_key, null) : null)
  message_key_wo_version    = try(each.value.protocols.radius.enable_key_wrap.message_key_version, local.defaults.catalyst_center.system_settings.authentication_and_policy_servers.aaa.protocols.radius.enable_key_wrap.message_key_version, 1)
}
