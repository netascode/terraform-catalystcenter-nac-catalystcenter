...
resource "catalystcenter_credentials_https_read" "https_read_credentials" {
  ...
  password_wo         = sensitive(try(each.value.password, local.defaults.catalyst_center.network_settings.device_credentials.https_read_credentials.password, null))
...
resource "catalystcenter_credentials_https_write" "https_write_credentials" {
  ...
  password_wo         = sensitive(try(each.value.password, local.defaults.catalyst_center.network_settings.device_credentials.https_write_credentials.password, null))
...
resource "catalystcenter_credentials_cli" "cli_credentials" {
  ...
  password_wo                = sensitive(try(each.value.password, local.defaults.catalyst_center.network_settings.device_credentials.cli_credentials.password, null))
  ...
  enable_password_wo         = sensitive(try(each.value.enable, local.defaults.catalyst_center.network_settings.device_credentials.cli_credentials.enable, null))
...
resource "catalystcenter_credentials_snmpv2_read" "snmpv2_read_credentials" {
  ...
  description               = each.key
  read_community_wo         = sensitive(try(each.value.read_community, local.defaults.catalyst_center.network_settings.device_credentials.snmpv2_read_credentials.read_community, null))
...
resource "catalystcenter_credentials_snmpv2_write" "snmpv2_write_credentials" {
  ...
  description                = each.key
  write_community_wo         = sensitive(try(each.value.write_community, local.defaults.catalyst_center.network_settings.device_credentials.snmpv2_write_credentials.write_community, null))
...
resource "catalystcenter_credentials_snmpv3" "snmpv3_credentials" {
  ...
  privacy_password_wo         = sensitive(try(each.value.privacy_password, local.defaults.catalyst_center.network_settings.device_credentials.snmpv3_credentials.privacy_password, null))
  ...
  auth_password_wo            = sensitive(try(each.value.auth_password, local.defaults.catalyst_center.network_settings.device_credentials.snmpv3_credentials.auth_password, null))
...
resource "catalystcenter_aaa_settings" "aaa_servers" {
  ...
  network_aaa_shared_secret_wo         = sensitive(try(local.aaa_settings[each.value.aaa_servers].network_aaa.shared_secret, local.defaults.catalyst_center.network_settings.aaa_servers.network_aaa.shared_secret, null))
  network_aaa_shared_secret_wo_version = try(local.aaa_settings[each.value.aaa_servers].network_aaa.shared_secret_version, local.defaults.catalyst_center.network_settings.aaa_servers.network_aaa.shared_secret_version, 1)
  ...
  client_aaa_shared_secret_wo          = sensitive(try(local.aaa_settings[each.value.aaa_servers].client_and_endpoint_aaa.shared_secret, local.defaults.catalyst_center.network_settings.aaa_servers.client_and_endpoint_aaa.shared_secret, null))
  client_aaa_shared_secret_wo_version  = try(local.aaa_settings[each.value.aaa_servers].client_and_endpoint_aaa.shared_secret_version, local.defaults.catalyst_center.network_settings.aaa_servers.client_and_endpoint_aaa.shared_secret_version, 1)
